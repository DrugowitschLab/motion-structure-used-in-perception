...
%Record frames that you use for tracking
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%FILENAME
response_filename = ['Response_File_Thresholding_P' num2str(subNum) '.mat'];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
cd(main_path);
cd('Trials')
cd('independent_thresh')
cd(speed);

potential_files= dir('trial*.*');
num_potential_files=size(potential_files,1);
trial_order=randperm(num_potential_files);
...
for i=1:30
    ...
    chosen_trial=trial_order(i);
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    filename = potential_files(chosen_trial).name;
    load(filename);
    cd(main_path);
    ...
    ResponseInfo(i).condition='Independent';
